...
@section( 'title', 'Certificates | '. Auth::user()->title .' '. Auth::user()->first_name .' '. Auth::user()->middle_name . ' '. Auth::user()->last_name )
                ...
                <div class="col-md-9">
                    <div class="profile-content">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="">Your Conference Certificates Will Appear Here</p>
                                <br>
