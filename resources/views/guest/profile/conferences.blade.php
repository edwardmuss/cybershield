...
@section( 'title', 'Conferences | '. Auth::user()->title .' '. Auth::user()->first_name .' '. Auth::user()->middle_name . ' '. Auth::user()->last_name )
                ...
                <div class="col-md-9">
                    <div class="profile-content">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="">Here is our upcoming conferences</p>
                                <br>
                                <ul class="txt-list">
                                    @foreach($upcoming_events as $event)
                                        <li class="" title="View Details"><a href="{{ route('events.show', $event->slug) }}" target="_blank" rel="noopener noreferrer">{{ $event->title }}</a></li>
                                        <hr>
                                    @endforeach
                                </ul>
                                <p class="text-center">
