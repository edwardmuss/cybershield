...
@section('content')
    ...
    {!! Form::model($speaker, ['method' => 'PUT', 'files' =>true,'enctype'=>'multipart/form-data', 'route' => ['admin.speakers.update', $speaker->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    @endif
                    <img src="{{ asset('uploads/speakers') }}/{{ $speaker->image }}" width="100" alt="">
                </div>
            </div>
