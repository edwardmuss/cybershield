...
<div class="lgx-container ">
    ...
    <header>
        <div id="lgx-header" class="lgx-header">
            <div class="lgx-header-position lgx-header-position-white2 lgx-header-position-fixed2"> <!--lgx-header-position-fixed lgx-header-position-white lgx-header-fixed-container lgx-header-fixed-container-gap lgx-header-position-white-->
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            <div class="lgx-nav-right navbar-right">
                                <div class="lgx-cart-area">
                                    ...
                                    @else
                                        <a class="lgx-btn lgx-btn-red" href="{{ route('auth.login') }}">Login/Register</a>
                                    @endif
                                </div>
                            </div>
                            <ul class="nav navbar-nav lgx-nav navbar-right">
                                <li><a href="{{ route('guest.home') }}">Home</a></li>
                                <li><a href="{{ route('event-speakers.index') }}">Recent Speakers</a></li>
                                <li><a href="{{ route('sponsors-and-partners.index') }}">Partners</a></li>
                                {{-- <li><a class="lgx-scroll" href="contact.html">Contact</a></li> --}}
                                <li><a  href="https://daystar.ac.ke">Main Website</a></li>
